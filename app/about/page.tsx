...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'না, টার্ফবুকে কোনো অতিরিক্ত বা লুকানো ফি নেই। এরেনার প্রকৃত অফিশিয়াল রেটেই আপনি বুকিং করতে পারবেন। আমরা স্বচ্ছতায় বিশ্বাসী।',
  },
  {
    question: 'যদি বুকিং করার পর ভেন্যুর কারণে খেলা ব্যাহত বা বাতিল হয়, তবে কি রিফান্ড পাবো?',
    answer:
      'হ্যাঁ, ভেন্যুজুড়ে কোনো টেকনিক্যাল প্রবলেম বা ডাবল বুকিং জনিত সমস্যা হলে আমরা ১০০% মানি-ব্যাক রিফান্ড গ্যারান্টি প্রদান করি। আমাদের ইনস্ট্যান্ট গেটওয়ে রিফান্ড ২৪ ঘণ্টার মধ্যে প্রসেস করা হয়।',
  },
  {
    question: 'খেলার কোনো স্লট বুকিং করার পর কি রিশেডিউল বা বাতিল করা সম্ভব?',
    answer:
      'বুকিং রিশেডিউলিং পলিসি মূলত নির্দিষ্ট মাঠ কর্তৃপক্ষের উপর নির্ভর করে। তবে ম্যাচ শুরু হওয়ার অন্তত ১২ ঘণ্টা আগে সরাসরি আমাদের ড্যাশবোর্ড বা কাস্টমার সাপোর্টে যোগাযোগ করলে আমরা রিশেডিউলে সর্বাত্মক সহায়তা করি।',
  },
  {
    question: 'আমি কিভাবে আমার মাঠ বা টার্ফ এরেনাকে টার্ফবুকে পার্টনার হিসেবে নথিভুক্ত করতে পারি?',
    answer:
      'আমাদের প্ল্যাটফর্মে এরেনা যুক্ত করা অত্যন্ত সহজ। ভেন্যু ওনাররা সরাসরি আমাদের ওনার ড্যাশবোর্ডে গিয়ে বা যোগাযোগ পৃষ্ঠার মাধ্যমে ভেন্যুর তথ্যাদি সাবমিট করলেই আমাদের টিম ভেরিফিকেশন সম্পন্ন করে ৪ ঘন্টার মধ্যে লাইভ করে দেয়।',
  },
];
...
const TESTIMONIALS = [
  {
    quote:
      'টার্ফবুকের আসার আগে ৫ বার ডাবল বুকিংয়ের শিকার হয়েছিলাম। ম্যাচ খেলতে গিয়ে দেখি অন্য টিম খেলছে। টার্ফবুক আসার পর এক ক্লিকে মাঠ লক করে নিশ্চিত মনে মাঠে যাই। এটা আমাদের ঢাকার স্পোর্টস লাইফ সহজ করে দিছে!',
    author: 'রাফসান জামিল',
  ...
  {
    quote:
      'আমি যখন আমার মিরপুরের ভেন্যু টার্ফবুকে যুক্ত করলাম, আমাদের স্লট অকুপেন্সি ৩০% থেকে বেড়ে ৮০% এ দাঁড়িয়েছে। অটোমেটেড বুকিং ট্র্যাকারের কারণে আমাদের ভেন্যু স্টাফদের উপর চাপ নেই।',
  ...
  {
    quote:
      'আমার ফ্রেন্ড গ্রুপে প্লেয়ার শর্ট পড়লে টার্ফবুকের লবি ফিচারের মাধ্যমে ইনস্ট্যান্ট খেলোয়াড় খুঁজে নেই। এই সামাজিক ও প্রযুক্তিগত চমৎকার ফিউশন ঢাকার ক্রীড়া বিপ্লব ডেকে আনছে!',
    author: 'সারাফাত কবির',
...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const sections = pageContainerRef.current?.querySelectorAll(
        'section, .timeline-container, .oath-section',
      );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(600px circle at var(--spotlight-x) var(--spotlight-y), rgba(16,185,129,0.06), transparent 50%)',
        }}
      />
      ...
      <div className="max-w-6xl mx-auto space-y-24 relative z-10">
        ...
        <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 will-change-transform">
          {[
            {
            ...
            {STEP_FLOW.map((step, i) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <span className="text-3xl font-black text-emerald-500/25 font-mono">
                    {step.step}
                  </span>
        ...
        <section className="gamification-section space-y-10">
          <div className="text-center space-y-2 max-w-2xl mx-auto scroll-fade-in">
            ...
            <h2 className="text-2xl sm:text-4xl font-black tracking-tight text-white">
              Your Future TurfBook Career
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-semibold">
              আমরা তৈরি করছি দেশের প্রথম প্লেয়ার প্রোফাইল ড্যাশবোর্ড। আপনার পজিশন সিলেক্ট করে দেখুন
              ক্যারিয়ার কার্ড কেমন দেখাবে!
            </p>
          </div>
          ...
          <div className="scroll-fade-in grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-[#0d1425]/15 border border-slate-900 rounded-3xl p-6 sm:p-8 relative overflow-hidden">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed font-medium">
                টার্ফবুকের ভবিষ্যৎ সংস্করণে প্রতিটি ম্যাচ খেলার পর ভেন্যু ও খেলোয়াড়দের ফিডব্যাকের
                মাধ্যমে আপনার প্রোফাইলের স্কিল পয়েন্ট বৃদ্ধি পাবে। আপনি ঢাকার সেরা স্ট্রাইকার নাকি
                অভেদ্য ডিফেন্ডার? তা দেখা যাবে সরাসরি আপনার টার্ফবুক স্পোর্টস আইডি-তে!
              </p>
              ...
              <div className="w-full max-w-[310px] bg-gradient-to-b from-[#111a2d] to-[#080d1a] border border-emerald-500/30 rounded-3xl p-5.5 relative shadow-[0_20px_50px_rgba(5,8,17,0.8)] hover:border-emerald-500/50 transition-all duration-500 group select-none">
                ...
                <div className="my-5 flex items-center gap-4 relative z-10">
                  ...
                  <div className="ml-auto text-right">
                    ...
                    <div className="text-[8px] font-black text-slate-500 tracking-widest uppercase">
                      OVR
                    </div>
                  </div>
                </div>
        ...
        <section className="space-y-8 max-w-5xl mx-auto pt-6">
          <div className="text-center space-y-1.5 pb-2 scroll-fade-in">
            ...
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">
              কিভাবে ফুটবলপ্রেমীদের একটি আইডিয়া বদলে দিল ঢাকার খেলার ধরণ
            </p>
          </div>
        ...
        <section className="team-section space-y-10">
          <div className="text-center space-y-2 max-w-2xl mx-auto scroll-fade-in">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-semibold">
              যাদের অক্লান্ত পরিশ্রম ও প্রযুক্তির ফিউশনে পরিচালিত হচ্ছে ঢাকা শহরের সেরা স্পোর্টস
              হাব।
            </p>
          </div>
            ...
            {FAQ_ITEMS.map((faq, i) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`p-1.5 rounded-full border border-slate-850 flex items-center justify-center flex-shrink-0 transition-transform duration-300 ${
                      openFaq === i
                        ? 'rotate-185 bg-emerald-500/10 border-emerald-500/20 text-emerald-400'
                        : 'text-slate-400'
                    }`}
                  >
          ...
          >
            ...
            <div className="space-y-3.5 flex-grow">
              ...
              <p className="text-[11px] sm:text-xs text-slate-400 font-medium leading-relaxed italic">
                &ldquo;টার্ফবুক শুধুমাত্র মাঠ বুকিং অ্যাপ নয়। আমরা যখন প্রথমবার ডাবল-বুকিং এর তিক্ত
                অভিজ্ঞতার মুখোমুখি হয়েছিলাম, তখনই ঠিক করেছিলাম—ঢাকার মাঠে কোন ফুটবল বা ক্রিকেট ম্যাচ
                যেন বুকিং জটিলতায় নষ্ট না হয়। প্রতিটি বুকিং যেন হয় রিলায়েবল ও ইনস্ট্যান্ট।&rdquo;
              </p>
              ...
              <div className="flex items-center justify-between text-[10px] font-bold text-slate-500">
                ...
                <Magnetic range={15} actionStrength={0.25}>
                  <Link
                    href="/turfs"
                    className="text-emerald-400 flex items-center gap-0.5 group hover:text-emerald-350 transition-colors"
                  >

...
import { HelpCircle, Lock, Mail, Trophy, Sparkles, Eye, EyeOff } from 'lucide-react';
      ...
      >
        ...
        <form onSubmit={handleLogin} ref={formItemsRef} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs font-bold px-0.5 pt-1 will-change-transform">
            ...
            <Link href="#" className="text-emerald-400 hover:text-emerald-350 transition-colors duration-300">
              Forgot password?
            </Link>
          </div>
